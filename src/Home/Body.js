              ...
              <div className="text-center text-xxl-start">
                <div className = "badge bg-gradient-primary-to-secondary text-white mb-4">
                  <div className = "text-uppercase">
                    Website & App Development &middot; mern stack &middot; ruby on rails
                  </div>
                </div>
                <div className="fs-3 fw-light text-muted">I will help to bring your</div>
                <h1 className="display-2 fw-bolder mb-5"><span className="text-gradient d-inline">Business to digital world</span></h1>
